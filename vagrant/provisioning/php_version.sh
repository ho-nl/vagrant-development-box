...
if [ $VAGRANT_PHP_VERSION == "7.2" ]; then
    if [ $(program_is_installed php7.2) == 0 ]; then
        ...
        sudo DEBIAN_FRONTEND=noninteractive apt-get -o DPkg::Options::=--force-confdef -yq install php7.2 php7.2-bcmath php7.2-cli php7.2-common php7.2-curl php7.2-dev php7.2-fpm php7.2-gd php7.2-imap php7.2-intl php7.2-json php7.2-ldap php7.2-mbstring php7.2-mysql php7.2-odbc php7.2-opcache php7.2-pgsql php7.2-pspell php7.2-readline php7.2-soap php7.2-sybase php7.2-tidy php7.2-xml php7.2-xmlrpc php7.2-zip php7.2-imagick
